...
Filter_node1696363744346 = Filter.apply(
    frame=customerlanding_node1,
    f=lambda row: (not (row["shareWithResearchAsOfDate"] == 0)),
    transformation_ctx="Filter_node1696363744346",
)

# Script generated for node Trusted Customer Zone
TrustedCustomerZone_node2 = glueContext.write_dynamic_frame.from_options(
    frame=Filter_node1696363744346,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://erics-stedi-lakehouse/customer/trusted/",
        "partitionKeys": [],
    },
